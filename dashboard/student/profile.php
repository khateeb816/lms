...
$sqlSemesterName = $conn->query("SELECT `title` FROM `semesters` WHERE `id` = '$semester_id'");
$semesterName = $sqlSemesterName->fetch_assoc()['title'];
    ...
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                ...
                <span class="text-black-50"><?php echo $semesterName; ?></span>
            </div>
        </div>
